...
INSERT INTO `alumni` (`id`, `nisn`, `password`, `nama_lengkap`, `jenis_kelamin`, `email`, `telp`, `tempat_lahir`, `tanggal_lahir`, `tahun_lulus`, `id_jurusan`, `id_kabupaten`, `id_provinsi`, `agama`, `profesi`, `alamat`, `foto`) VALUES
...
(8, 'footer', '<p>© 2017 SMANSARI - All Rights Reserved.</p>'),
...
--
ALTER TABLE `jurusan`
  MODIFY `id_jurusan` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `alumni`
  ADD CONSTRAINT `alumni_ibfk_1` FOREIGN KEY (`id_jurusan`) REFERENCES `jurusan` (`id_jurusan`) ON DELETE SET NULL ON UPDATE CASCADE,
