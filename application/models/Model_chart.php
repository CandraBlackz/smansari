...
class Model_chart extends CI_Model
{
	...
	{	
		$data = $this->db->query("SELECT jurusan.nama_jurusan, COUNT(id) as hasil FROM jurusan INNER JOIN alumni ON alumni.id_jurusan = jurusan.id_jurusan where nama_jurusan!='NULL' GROUP BY nama_jurusan");	
		return $data;
	}
