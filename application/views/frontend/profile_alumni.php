  ...
  <div class="row">
    ...
    <section class="flat-row flat-member-single padding-v1">
      <div class="container">
                  ...
                  <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo site_url('alumni/simpan');?>">
                      ...
                      <table class="table table-bordered">
                        ...
                        <tr><td><b>NISN :</b></td>
                        <td>
                          <input type="text-area" class="form-control" id="nisn" name="nisn" required="" value="<?php echo $qu['nisn']; ?>"> 
                        </td>
                      </tr>
        ...
        <td>
          <?php
          echo cmb_dinamis('id_jurusan', 'jurusan', 'nama_jurusan', 'id_jurusan',$qu['id_jurusan']);
          ?>
        </td>
      </tr>
